...
if minetest.get_modpath("moreblocks") then
	...
	minetest.register_alias("building_blocks:slab_tar","building_blocks:slab_Tar")
	minetest.register_alias("building_blocks:stair_tar","building_blocks:stair_Tar")
	minetest.register_alias("building_blocks:slab_marble","building_blocks:slab_Marble")
	minetest.register_alias("building_blocks:stair_marble","building_blocks:stair_Marble")
end
